...
func ReturnOneFundsTx(UrlHash string) utilities.Fundstx {
	...
	row := db.QueryRow(sqlStatement, UrlHash)
	switch err = row.Scan(&returnedrow.Header, &returnedrow.Hash, &returnedrow.BlockHash, &returnedrow.Amount, &returnedrow.Fee, &returnedrow.TxCount, &returnedrow.From, &returnedrow.To, &returnedrow.Signature); err {
	case sql.ErrNoRows:
	case nil:
		return returnedrow
	default:
...
func ReturnOneAccTx(UrlHash string) utilities.Acctx {
	...
	row := db.QueryRow(sqlStatement, UrlHash)
	switch err = row.Scan(&returnedrow.Header, &returnedrow.Hash, &returnedrow.BlockHash, &returnedrow.Issuer, &returnedrow.Fee, &returnedrow.PubKey, &returnedrow.Signature); err {
	case sql.ErrNoRows:
	case nil:
		return returnedrow
	default:
...
func ReturnOneConfigTx(UrlHash string) utilities.Configtx {
	...
	row := db.QueryRow(sqlStatement, UrlHash)
	switch err = row.Scan(&returnedrow.Header, &returnedrow.Hash, &returnedrow.BlockHash, &returnedrow.Id, &returnedrow.Payload, &returnedrow.Fee, &returnedrow.TxCount, &returnedrow.Signature); err {
	case sql.ErrNoRows:
	case nil:
		return returnedrow
	default:
...
func ReturnOneStakeTx(UrlHash string) utilities.Staketx {
	...
	row := db.QueryRow(sqlStatement, UrlHash)
	switch err = row.Scan(&returnedrow.Header, &returnedrow.Hash, &returnedrow.BlockHash, &returnedrow.Fee, &returnedrow.Account, &returnedrow.IsStaking, &returnedrow.Signature); err {
	case sql.ErrNoRows:
	case nil:
		return returnedrow
	default:
...
func ReturnOneAccount(UrlHash string) utilities.Accountwithtxs {
	...
	row := db.QueryRow(sqlStatement, UrlHash)
	switch err = row.Scan(&returnedaccount.Hash, &returnedaccount.Address, &returnedaccount.Balance, &returnedaccount.TxCount, &returnedaccount.IsStaking); err {
	case sql.ErrNoRows:
