        ...
        axios.get('http://192.41.136.199:8001/account/' + app.accountinfo.rootpublickey).then(
          function(response) {
            ...
            if (response.data.isRoot) {
              axios.post(`http://192.41.136.199:8001/createConfigTx/${0}/${1}/${app.blocksize.blocksize}/${app.blocksize.fee}/${app.accountinfo.txcount}`).then(
                function(response) {
                  $("#myModal").modal()
                  console.log(response.data);
      ...
      if (app.isPositiveInt(diffinterval) && app.isPositiveInt(fee)) {
        axios.get('http://192.41.136.199:8001/account/' + app.accountinfo.rootpublickey).then(
          function(response) {
            ...
            app.accountinfo.txcount = response.data.txCnt
            if (response.data.isRoot) {
              axios.post(`http://192.41.136.199:8001/createConfigTx/${0}/${2}/${app.diffinterval.diffinterval}/${app.diffinterval.fee}/${app.accountinfo.txcount}`).then(
                function(response) {
                  $("#myModal").modal()
                  console.log(response.data);
                  app.accountinfo.txhash = response.data.content[0].detail
      ...
      if (app.isPositiveInt(minfee) && app.isPositiveInt(fee)) {
        axios.get('http://192.41.136.199:8001/account/' + app.accountinfo.rootpublickey).then(
          function(response) {
            ...
            app.accountinfo.txcount = response.data.txCnt
            if (response.data.isRoot) {
              axios.post(`http://192.41.136.199:8001/createConfigTx/${0}/${3}/${app.minfee.minfee}/${app.minfee.fee}/${app.accountinfo.txcount}`).then(
                function(response) {
                  $("#myModal").modal()
                  console.log(response.data);
                  app.accountinfo.txhash = response.data.content[0].detail
      ...
      if (app.isPositiveInt(blockinterval) && app.isPositiveInt(fee)) {
        axios.get('http://192.41.136.199:8001/account/' + app.accountinfo.rootpublickey).then(
          function(response) {
            ...
            app.accountinfo.txcount = response.data.txCnt
            if (response.data.isRoot) {
              axios.post(`http://192.41.136.199:8001/createConfigTx/${0}/${4}/${app.blockinterval.blockinterval}/${app.blockinterval.fee}/${app.accountinfo.txcount}`).then(
                function(response) {
                  $("#myModal").modal()
                  console.log(response.data);
                  app.accountinfo.txhash = response.data.content[0].detail
      ...
      if (app.isPositiveInt(blockreward) && app.isPositiveInt(fee)) {
        axios.get('http://192.41.136.199:8001/account/' + app.accountinfo.rootpublickey).then(
          function(response) {
            ...
            app.accountinfo.txcount = response.data.txCnt
            if (response.data.isRoot) {
              axios.post(`http://192.41.136.199:8001/createConfigTx/${0}/${5}/${app.blockreward.blockreward}/${app.blockreward.fee}/${app.accountinfo.txcount}`).then(
                function(response) {
                  $("#myModal").modal()
                  console.log(response.data);
                  app.accountinfo.txhash = response.data.content[0].detail
